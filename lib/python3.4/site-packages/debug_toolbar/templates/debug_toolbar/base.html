...
<link rel="stylesheet" href="/staticfiles/debug_toolbar/css/print.css" type="text/css" media="print" />
<link rel="stylesheet" href="/staticfiles/debug_toolbar/css/toolbar.css" type="text/css" /> {% if toolbar.config.JQUERY_URL %}
<!-- Prevent our copy of jQuery from registering as an AMD module on sites that use RequireJS. -->
<script src="/staticfiles/debug_toolbar/js/jquery_pre.js"></script>
<script src="{{ toolbar.config.JQUERY_URL }}"></script>
<script src="/staticfiles/debug_toolbar/js/jquery_post.js"></script>
{% else %}
<script src="/staticfiles/debug_toolbar/js/jquery_existing.js"></script>
{% endif %}
<script src="/staticfiles/debug_toolbar/js/toolbar.js"></script>
<div id="djDebug" class="djdt-hidden" dir="ltr" data-store-id="{{ toolbar.store_id }}" data-render-panel-url="{% url 'djdt:render_panel' %}" {{ toolbar.config.ROOT_TAG_EXTRA_ATTRS|safe }}>
    <div class="djdt-hidden" id="djDebugToolbar">
        <ul id="djDebugPanelList">
            ...
            {% endif %} {% for panel in toolbar.panels %}
...
<div id="{{ panel.panel_id }}" class="djdt-panelContent">
    ...
    <div class="djDebugPanelContent">
        {% if toolbar.store_id %}
        <img src="/staticfiles/debug_toolbar/img/ajax-loader.gif" alt="loading" class="djdt-loader" />
