...
urlpatterns = [
    ...
    url(r'^comunity/$', TemplateView.as_view(
        template_name='pages/comunity.html'), name='comunity'),
    url(r'^stat/$', TemplateView.as_view(
    ...
    url(r'^partners/$', TemplateView.as_view(
        template_name='pages/partners.html'), name='partners'),

    # Django Admin, use {% url 'admin:index' %}
    url(settings.ADMIN_URL, admin.site.urls),

    # User management
    url(r'^users/', include('smart4_portal.users.urls', namespace='users')),
